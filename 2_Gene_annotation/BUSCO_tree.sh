...
threads=60
busco_path="/data/home/s2215768/fly_annotation/data/CAT_genomes/selected_genomes/BUSCO/"
wd=`pwd`
...
species_num=$(find . -type d -name "single_copy_busco_sequences"|wc -l)
missing_no=1
...
alnthreads="1" #num threads per process
...
mkdir -p iqtree
treethreads="4" #num threads per process
